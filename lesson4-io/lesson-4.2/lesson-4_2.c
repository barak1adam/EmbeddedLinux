 ...
 * 1. At first glance the progrm doesn't work, Why ? - barak: need to mkdir /tmp/dir
 * 2. What is the unlink call used for ?
 * 3. What is the program used for ? barak: two program communiate by a file
 * 4. Do you recognize an potential bugs ? barak: no free of allocated buffer
 */
